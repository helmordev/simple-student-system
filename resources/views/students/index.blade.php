                ...
                <table class="w-full border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-600">
                            <td class="px-4 py-2 border text-white">{{ $student->name }}</td>
                            <td class="px-4 py-2 border text-white">{{ $student->email }}</td>
                            <td class="px-4 py-2 border text-white">{{ $student->course }}</td>
